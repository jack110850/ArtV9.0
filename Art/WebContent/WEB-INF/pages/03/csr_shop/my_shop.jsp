...
<div class="container">
	...
	<div class=content>
		<form method="post"
			action="<c:url value="/03/csr/shop/searchShopByShopNameAndMemberId.ctrl"/>">
			<div class="submitButton">
				...
				<c:if test="${acShopsList != null}">
					<c:forEach items="${acShopsList}" var="acShopsList" varStatus="vs">
						<tr>
							...
							<td>
								<form method="post"
									action="<c:url value="/03/csr/shop/shopDetails.ctrl"/>">
							...
							<td>
								<form method="post"
									action="<c:url value="/03/csr/shop/updateShopByShopId.ctrl"/>">
									<button name="updateButton" type="submit"
							...
							<td>
								<form method="post"
									action="<c:url value="/03/csr/shop/deleteShop.ctrl"/>">
