...
<body>
	...
	<div class="add" align="right">
		<input class="comfirmAdd" type="button" value="新增會員資料" onclick="add()">
		<div class="post">
			...
			<table class="display table">
				...
				<tbody>
					...
					<tr class="comfirmPost">
						<td colspan="4"><input type="button" value="確認新增" onclick="post()"></td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<tbody>
				<c:forEach var="list" items="${membersList}">
					<tr>
						...
						<td class="update">
							<div>
								<input type="button" value="修改" id="${list.name}"
									onclick="put(this.id)">
							</div>
						</td>
						<td class="delete">
							<div>
								<input type="button" value="刪除" id="${list.name}"
									onclick="del(this.id)">
							</div>
						</td>
					</tr>
