...
<body>
	...
	<div class="content">
		...
		<form action="<c:url value='/35/findNear.ctrl'/> " method="get">
			...
			<div class="submitButton">
				<input class="genric-btn primary radius" type="submit" name="submit" value="確認送出">
			</div>
		</form>
	</div>
	<br>
	...
	<c:forEach var="recommend" items="${recommend}">
		...
		<input class="genric-btn primary radius" type="button" onclick="navigate(this.id)" id="${addr}"
			value="幫我導航">
		<div><br></div>
	</c:forEach>
	</div>
	...
	<div class="content">
		...
		<form action="<c:url value='/35/founding.ctrl'/> " method="get">
			...
			<br>
			<div class="submitButton">
				<input class="genric-btn primary radius" type="submit" name="submit" value="好奇嗎？點下去就對了">
			</div>
		</form>
	</div>
