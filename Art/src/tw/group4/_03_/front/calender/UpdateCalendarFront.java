...
public class UpdateCalendarFront {
	...
	@RequestMapping(path = "/03/front/calendar/updateCalendarConfirm.ctrl", method = RequestMethod.POST)
	public String updateCalendarConfirm(HttpServletRequest request, Model m) {
		...
		return IdentityFilter.loginID+"03/front_calendar/update_confirm";
	}

	@RequestMapping(path = "/03/front/calendar/updateCalendar.ctrl", method = RequestMethod.POST)
	public String updateCalendar(@RequestParam(name = "shopId") String shopId,
		...
		return IdentityFilter.loginID+"03/front_calendar/update_return";
	}
