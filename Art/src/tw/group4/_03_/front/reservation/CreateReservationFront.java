...
public class CreateReservationFront {
	...
	public String createReservationDate(@RequestParam(name = "memberId") String memberId,
			@RequestParam(name = "memberName") String memberName, @RequestParam(name = "shopId") String shopId,
			@RequestParam(name = "shopName") String shopName, @RequestParam(name = "intro") String intro, Model m) {
		try {
	...
	public String createReservationConfirm(@RequestParam(name = "memberId") String memberId,
			@RequestParam(name = "memberName") String memberName, @RequestParam(name = "shopId") String shopId,
			@RequestParam(name = "shopName") String shopName, @RequestParam(name = "dateTime") String dateTime,
			Model m) {
...
//				#取得當天已預約的時段
	...
	public String createReservation(@RequestParam(name = "memberId") String memberId,
			@RequestParam(name = "memberName") String memberName, @RequestParam(name = "shopId") String shopId,
...
//			@RequestParam(name="childrenNum") String childrenNum,
			...
			@RequestParam(name = "dateTime") String dateTime, @RequestParam(name = "startTime") String startTime,
			@RequestParam(name = "endTime") String endTime, @RequestParam(name = "note") String note, Model m) {
		try {
