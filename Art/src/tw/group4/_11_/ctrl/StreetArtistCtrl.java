...
//	總覽
	...
	public String showingSA(Model m) {
		...
		return IdentityFilter.loginID+"_11_SA/Show_SA";
	}
//	C
	...
	public String goCreate(Model m) {
		...
		return IdentityFilter.loginID+"_11_SA/NewSA";
	}
	...
	public String createeSA(@RequestParam(name = "NAME_SA") String name,
		...
		return IdentityFilter.loginID+"_11_SA/Success";
	}
//	R
	...
	public String goDel(Model m) {
		StreetArtistBean streetArtist = new StreetArtistBean();
    	m.addAttribute("streetArtist", streetArtist);
		return IdentityFilter.loginID+"_11_SA/DelSA";
	}
//	照ID刪
...
//	U
	...
	public String fixSA(
		...
		return IdentityFilter.loginID+"_11_SA/FixSA";
//多傳一個變數裝id_SASA
	}
...
//	D
	...
	public String goSearch(Model m) {
		StreetArtistBean streetArtist = new StreetArtistBean();
    	m.addAttribute("streetArtist", streetArtist);
		return IdentityFilter.loginID+"_11_SA/SearchSA";
	}
